  ...
  pages: {
    ...
    settings: {
      ...
      dashboard: {
        ...
        updateInstallProgressOpenLink: "Opening the update download link…",
        updateInstallProgressDownload: "Downloading update package…",
        updateInstallProgressApply: "Installing update…",
        updateInstallProgressDone: "Download link opened. Follow the installer to finish the update…",
        autoUpdatePromptTitle: "Update Available",
        autoUpdatePromptBody: "Version {version} is available. Open the update download now?",
        updateDownloadStartedTitle: "Update Download Started",
        updateDownloadStartedMessage: "The update download link has been opened in your system. After the installer is downloaded, follow its steps to finish the upgrade.",
