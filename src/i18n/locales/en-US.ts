export const enUS = {
  ...
  aiEnhancement: {
    ...
    runtimeStatus: {
      ...
      DOWNLOADING: "Preparing AI enhancement runtime package",
  ...
  pages: {
    ...
    settings: {
      ...
      aiModules: {
        ...
        pathModeDefaultDesc: "By default, AI runtime and models are stored under the current app install directory.",
        pathModeCustomDesc: "Use custom folders for AI runtime and model files. Make sure the selected folders are writable.",
        runtimeStorageRootTitle: "AI runtime storage",
        runtimeStorageRootDesc: "This folder stores the imported runtime manifest, versions, and current runtime copy.",
        runtimeStorageEmptyHint: "Choose a folder for the AI runtime storage.",
        modelsStorageRootTitle: "AI model storage",
        modelsStorageRootDesc: "This folder stores imported model files and Torch cache data.",
        modelsStorageEmptyHint: "Choose a folder for the AI model storage.",
        defaultRuntimeRootLabel: "Default runtime folder: {path}",
        defaultModelsRootLabel: "Default model folder: {path}",
        restoreDefaultTitle: "Restore default folders",
        restoreDefaultDesc: "Switch back to the install-directory-based storage scheme.",
        restoreDefaultAction: "Use default folders",
      ...
      dashboard: {
        ...
        minimizeTrayDesc: "Keep a tray icon after closing the main window. Restore or quit from the tray.",
        confirmCloseTitle: "Confirm before closing",
        confirmCloseDesc: "Ask for confirmation when closing to avoid accidents.",
        closeConfirmQuitTitle: "Quit Tooliva",
        closeConfirmQuitMessage: "Are you sure you want to quit Tooliva? Active tasks may be interrupted.",
        closeConfirmQuitConfirm: "Quit",
        closeConfirmTrayTitle: "Minimize to tray",
        closeConfirmTrayMessage: "The app will keep running in the system tray. You can restore the window from the tray icon.",
        closeConfirmTrayConfirm: "Minimize to tray",
        closeConfirmCancel: "Cancel",
        trayMenuShow: "Show main window",
        trayMenuQuit: "Quit",
        trayTooltip: "Tooliva",
    ...
    imageWatermarkRemoval: {
      ...
      model: {
        ...
        downloadingFirstUse: "Preparing imported LaMA model",
        lamaReady: "LaMA model ready",
        downloading: "Preparing LaMA model files",
