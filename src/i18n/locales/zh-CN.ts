  ...
  pages: {
    ...
    settings: {
      ...
      dashboard: {
        ...
        updateInstallProgressOpenLink: "正在打开更新下载链接…",
        updateInstallProgressDownload: "正在下载更新包…",
        updateInstallProgressApply: "正在安装更新…",
        updateInstallProgressDone: "下载链接已打开，请按提示完成安装…",
        autoUpdatePromptTitle: "发现新版本",
        autoUpdatePromptBody: "检测到新版本 {version}。是否现在打开更新下载链接？",
        updateDownloadStartedTitle: "更新下载已开始",
        updateDownloadStartedMessage: "已在系统中打开更新下载链接。下载安装包后，按安装向导完成升级即可。",
